...
class CancelledAppointmentTable extends StatefulWidget {
  const CancelledAppointmentTable({Key? key}) : super(key: key);

  @override
  CancelledAppointmentTableState createState() =>
      CancelledAppointmentTableState();
}

class CancelledAppointmentTableState extends State<CancelledAppointmentTable> {
                                        ...
                                        subtitle: Padding(
                                            ...
                                            child: Column(children: [
                                              ...
                                              AppointmentColumn(
                                                  data: data[i],
                                                  status: TabStatus
                                                      .cancelledAppointment), // appointment COLUMN
                                              AppointmentStatus(
                                                  data: data[i],
          ...
          return AnimatedSwitcher(
              ...
              child: state is AppointmentRequestListsInitial
                  ...
                  : state is AppointmentRequestListsLoading
                      ? buildLoading()
                      : state is CancelledAppointmentLoaded
                          ? buildLoaded(state.cancelledRequest)
