...
class QuestionsHomeOwner extends StatefulWidget {
  final Function(bool completed, bool isSave, bool isInit) callback;
  const QuestionsHomeOwner({Key? key, required this.callback})
      : super(key: key);
  @override
  QuestionsHomeOwnerState createState() => QuestionsHomeOwnerState();
}

class QuestionsHomeOwnerState extends State<QuestionsHomeOwner> {
  ...
  void initState() {
    super.initState();
    analyticsSetCurrentScreen("Question Policy Owner", "QuestionPolicyOwner");
    tabList = {
      "poquestion": {
    ...
    currentTab = tabList["poquestion"]["route"];
  }
